...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nummus " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nummustools.com", "dnsseed.nummustools.com"},
    {"nummuspool.org", "dnsseed.nummuspool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"nummustools.com", "testnet-seed.nummustools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nummus is probably already running."), addrBind.ToString().c_str());
        else
